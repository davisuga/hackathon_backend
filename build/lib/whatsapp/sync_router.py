...
from typing import Awaitable, Optional, cast, Callable
...
def get_sync_router(agent: Optional[Agent] = None, team: Optional[Team] = None, context_loader: Optional[Callable[[str], Awaitable[dict]]] = None) -> APIRouter:
    router = APIRouter()
